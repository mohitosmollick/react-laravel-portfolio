                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach($clients as $key=>$list)
                            <tr>
                                ...
                                <td>
                                    <a href="" class="btn btn-danger shadow btn-xs sharp delete"><i class="fa fa-trash mt-1"></i></a>
                                    <a href="" class="btn btn-secondary shadow btn-xs sharp"><i class="fa fa-pencil mt-1"></i></a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
